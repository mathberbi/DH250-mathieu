...
![screenshot_app1-18](./app1_10.3.png)
**Severity Rating:** 2

### Heuristics Evaluation of KoreanClass101
#### (1) Visibility of System Status 
**(ALMOST) RESPECTED** - 1) Menu is not very contextual and doesn't show where you are. 
![screenshot_app2-1](./app2_1.png)

2) The dashboard gives you an overview of your progress in the pathway that you chose to follow. It also gives you statistics on how much you have learned for motivation.
![screenshot_app2-2](./app2_1.2.png)
**Severity Rating:** 1 

#### (2) Connection between System/Real World
**COMPLETE** - The prresentation of the levels is more appealing than TTMIK with a "task list" that seems more easy to understand. 
![screenshot_app2-3](./app2_2.png)
**Severity Rating:** 1

#### (3) User Control and Freedom
**RESPECTED** - 1) Way more control than in TTMIK because it doesn't use the integration of soundcloud - possibility to control the audio while looking at the rest of the lesson + read the dialogue sentence by sentence 
![screenshot_app2-4](./app2_3.png)
(Example of the layout of a lesson)

2) You can hide parts of the lesson, and elements that you do not want to see.
![screenshot_app2-5](./app2_3.2.png)

3) There are ways to go to a specific part but no ways to come back to the top of the page, which could be frustrating.
**Severity Rating:** 3

#### (4) Consistency and Standards
**(ALMOST COMPLETE)** - 1) Uses conventionl icons (external consistency)
![screenshot_app2-6](./app2_4.2.png)

2) However, there is a lack of consistency regarding the availability of the "contact" button that appears on the dashboard; in the bottom-right side. Once in the lesson, we can't access it.
![screenshot_app2-7](./app2_4.1.png)
**Severity Rating:** 1

#### (5) Error Prevention
**RESPECTED** - Ask questions before deleting/resetting the desk cards.
![screenshot_app2-8](./app2_5.png)
![screenshot_app2-9](./app2_5.2.png)
**Severity Rating:** 1

#### (6) Recognition rather than Recall
**NOT RESPECTED** - Even though you can choose a pathway and stick to it, if you do not do the lessons in the order they tell you, there is no way to know where you left it when you come back.
![screenshot_app2-10](./app2_6.png)

The only solution is to go in "My report" which is a page that is hidden in a contextual menu.
![screenshot_app2-11](./app2_6.2.png)
**Severity Rating:** 2

#### (7) Flexibility and Efficiency of Use
**ALMOST RESPECTED** - 1) Possibility to directly go to email account to activate account.
![screenshot_app2-12](./app2_7_10.png)

2) Shortcuts available to use when reviewing desks - but there is no way to know what they are unless we read the Q&A page.
![screenshot_app2-13](./app2_7.png)
![screenshot_app2-14](./app2_7.2.png)
**Severity Rating:** 2

#### (8) Aesthetic and Minimalist Design
**INCOMPLETE** - Even though there is, like TTMIK, a scrolling design - it is easier to navigate, thanks to the bar that is embedded at the top of the screen. Sometimes, the abundance of information might be a little confusing.
![screenshot_app2-15](./app2_8.png)
**Severity Rating:** 1

#### (9) Help users recognize, diagnose and recover from errors
**INCOMPLETE** - 1) Informs you about the password conditions.
![screenshot_app2-16](./app2_9.png)

2) - shows clearly the error and give you a way to reset the quiz to restart it. 
![screenshot_app2-17](./app2_9.2.png) 
(screen after taking a quiz)

3) When an error occurs during a search, there is no suggestion to recover.
![screenshot_app2-18](./app1_9.3.png) 
![screenshot_app2-19](./app2_9.4.png) 
**Severity Rating:** 2

#### (10) Help and Documentation
**INCOMPLETE** - 1) contextual help is provided for example for activation of the account 
![screenshot_app2-20](./app1_4_10.png)

2) However, the search feature is not very intuitive.
